...
function showLegalPage(page) {
  ...
  if (!document.getElementById('legal-styles')) {
    ...
    s.textContent = `
      ...
      .legal-logo{font-weight:800;font-size:18px;color:#1e293b;letter-spacing:-0.5px;}
      ...
      .legal-content a{color:#6366f1;text-decoration:none;font-weight:500;}
      .legal-content a:hover{text-decoration:underline;}
      .contact-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:16px;margin-bottom:32px;}
      .contact-card{background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:24px;text-align:center;transition:box-shadow .2s;}
      .contact-card:hover{box-shadow:0 4px 20px rgba(0,0,0,.08);}
      .contact-icon{font-size:32px;margin-bottom:10px;}
      .contact-card h3{font-size:14px;font-weight:700;color:#1e293b;margin:0 0 8px 0;}
      .contact-card p{color:#64748b;font-size:13px;line-height:1.6;margin:0 0 12px 0;}
      .contact-link{display:inline-block;background:#6366f1;color:#fff!important;padding:8px 16px;border-radius:8px;font-size:13px;font-weight:600;text-decoration:none!important;transition:background .2s;}
      .contact-link:hover{background:#4f46e5!important;}
      .contact-faq{background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:28px;}
      .contact-faq h3{font-size:16px;font-weight:700;color:#1e293b;margin:0 0 20px 0;}
      .faq-item{border-bottom:1px solid #f1f5f9;padding:16px 0;}
      .faq-item:last-child{border-bottom:none;padding-bottom:0;}
      .faq-item strong{color:#1e293b;font-size:14px;display:block;margin-bottom:6px;}
      .faq-item p{color:#64748b;font-size:14px;margin:0;line-height:1.6;}
      .legal-footer-bar{display:flex;justify-content:center;align-items:center;gap:14px;padding:20px;background:#fff;border-top:1px solid #e2e8f0;flex-wrap:wrap;}
      .legal-footer-link{color:#6366f1;font-size:13px;cursor:pointer;font-weight:500;}
      .legal-footer-link:hover{text-decoration:underline;}
      .legal-footer-sep{color:#cbd5e1;font-size:13px;}
      @media(max-width:600px){.legal-body{padding:32px 16px;}.legal-title{font-size:24px;}.legal-header{padding:14px 16px;}}
    `;
  ...
  if (page === 'privacy') {
    ...
    bodyContent = `
      <span class="legal-updated">Last updated: February 28, 2026</span>
      <h3>1. Introduction</h3>
      <p>Welcome to Smart Attendance. We are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you use our platform.</p>
      <h3>2. Information We Collect</h3>
      <ul>
        <li>Full name and email address</li>
        <li>Student index numbers or employee IDs</li>
      ...
      <ul>
        ...
        <li>Generate attendance reports for authorized administrators</li>
    ...
    bodyContent = `
      ...
      <p>By accessing or using Smart Attendance, you agree to be bound by these Terms of Service. If you do not agree, please do not use our platform.</p>
    ...
    bodyContent = `
      ...
      <div class="contact-faq">
        ...
        <div class="faq-item">
          ...
          <p>We accept all major cards and mobile money via Paystack (Ghana Cedis).</p>
        </div>
        <div class="faq-item">
          <strong>Can I export attendance reports?</strong>
          <p>Yes. Admins and managers can download attendance reports as PDFs from the Reports section.</p>
        </div>
        <div class="faq-item">
          <strong>How do employees or students join my institution?</strong>
          <p>Share your institution code (found on your admin dashboard) with your team. They enter it during registration.</p>
        </div>
      </div>
    `;
  }
